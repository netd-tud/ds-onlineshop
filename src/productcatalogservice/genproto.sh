...
protoc --proto_path=$protodir \
    ...
    --go_opt=Mcommon/common.proto=github.com/netd-tud/ds-onlineshop/src/productcatalogservice/genproto/common \
    --go-grpc_opt=Mcommon/common.proto=github.com/netd-tud/ds-onlineshop/src/productcatalogservice/genproto/common \
