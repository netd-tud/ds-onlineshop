...
protoc --proto_path=$protodir \
    ...
    --go_opt=Mcommon/common.proto=github.com/turt1z/microservices-demo/src/productcatalogservice/genproto/common \
    --go-grpc_opt=Mcommon/common.proto=github.com/turt1z/microservices-demo/src/productcatalogservice/genproto/common \
