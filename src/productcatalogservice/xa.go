...
func (p *productCatalog) XaPrepareCreateProduct(ctx context.Context, req *pb.XaPrepareCreateProductRequest) (*pb.Empty, error) {
	p.xaMu.Lock()
	defer p.xaMu.Unlock()

	if p.xaPending == nil {
		p.xaPending = map[string]*pb.Product{}
	}
...
func (p *productCatalog) XaCommitCreateProduct(ctx context.Context, req *pb.XaBranchRequest) (*pb.Empty, error) {
	p.xaMu.Lock()
	defer p.xaMu.Unlock()
...
func (p *productCatalog) XaRollbackCreateProduct(ctx context.Context, req *pb.XaBranchRequest) (*pb.Empty, error) {
	p.xaMu.Lock()
	defer p.xaMu.Unlock()
