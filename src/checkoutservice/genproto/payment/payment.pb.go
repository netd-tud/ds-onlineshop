...
const file_payment_payment_proto_rawDesc = "" +
	...
	"\x0etransaction_id\x18\x01 \x01(\tR\rtransactionId2\xa4\x01\n" +
	"\x0ePaymentService\x12C\n" +
	"\x06Charge\x12\x1a.hipstershop.ChargeRequest\x1a\x1b.hipstershop.ChargeResponse\"\x00\x12M\n" +
	"\x10CompensateCharge\x12\x1a.hipstershop.ChargeRequest\x1a\x1b.hipstershop.ChargeResponse\"\x00B;Z9github.com/netd-tud/ds-onlineshop/proto/payment;paymentpbb\x06proto3"
...
var file_payment_payment_proto_depIdxs = []int32{
	...
	1, // 3: hipstershop.PaymentService.CompensateCharge:input_type -> hipstershop.ChargeRequest
	2, // 4: hipstershop.PaymentService.Charge:output_type -> hipstershop.ChargeResponse
	2, // 5: hipstershop.PaymentService.CompensateCharge:output_type -> hipstershop.ChargeResponse
