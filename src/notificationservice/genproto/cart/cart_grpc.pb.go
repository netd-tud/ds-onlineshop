...
type CartServiceClient interface {
	AddItem(ctx context.Context, in *AddItemRequest, opts ...grpc.CallOption) (*common.Empty, error)
	GetCart(ctx context.Context, in *GetCartRequest, opts ...grpc.CallOption) (*Cart, error)
	EmptyCart(ctx context.Context, in *EmptyCartRequest, opts ...grpc.CallOption) (*common.Empty, error)
}
...
func (c *cartServiceClient) AddItem(ctx context.Context, in *AddItemRequest, opts ...grpc.CallOption) (*common.Empty, error) {
...
func (c *cartServiceClient) EmptyCart(ctx context.Context, in *EmptyCartRequest, opts ...grpc.CallOption) (*common.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Empty)
...
type CartServiceServer interface {
	AddItem(context.Context, *AddItemRequest) (*common.Empty, error)
	GetCart(context.Context, *GetCartRequest) (*Cart, error)
	EmptyCart(context.Context, *EmptyCartRequest) (*common.Empty, error)
...
func (UnimplementedCartServiceServer) AddItem(context.Context, *AddItemRequest) (*common.Empty, error) {
...
func (UnimplementedCartServiceServer) EmptyCart(context.Context, *EmptyCartRequest) (*common.Empty, error) {
