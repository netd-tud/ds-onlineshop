...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x0fauth/auth.proto\x12\x04auth"2\n\x0cLoginRequest\x12\x10\n\x08username\x18\x01 \x01(\t\x12\x10\n\x08password\x18\x02 \x01(\t"\x1e\n\rLoginResponse\x12\r\n\x05token\x18\x01 \x01(\t2?\n\x0bAuthService\x120\n\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB8Z6github.com/turt1z/microservices-demo/proto/auth;authpbb\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'auth.auth_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'Z6github.com/turt1z/microservices-demo/proto/auth;authpb'
