...
type ResolveStockAlertRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProductId     string                 `protobuf:"bytes,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	ReorderAmount int64                  `protobuf:"varint,3,opt,name=reorder_amount,json=reorderAmount,proto3" json:"reorder_amount,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ResolveStockAlertRequest) Reset() {
	*x = ResolveStockAlertRequest{}
	mi := &file_inventory_inventory_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResolveStockAlertRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResolveStockAlertRequest) ProtoMessage() {}

func (x *ResolveStockAlertRequest) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_inventory_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResolveStockAlertRequest.ProtoReflect.Descriptor instead.
func (*ResolveStockAlertRequest) Descriptor() ([]byte, []int) {
	return file_inventory_inventory_proto_rawDescGZIP(), []int{11}
}

func (x *ResolveStockAlertRequest) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
func (x *ResolveStockAlertRequest) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *ResolveStockAlertRequest) GetReorderAmount() int64 {
	if x != nil {
...
type ResolveStockAlertResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Product         *InventoryProduct      `protobuf:"bytes,1,opt,name=product,proto3" json:"product,omitempty"`
...
func (x *ResolveStockAlertResponse) Reset() {
	*x = ResolveStockAlertResponse{}
	mi := &file_inventory_inventory_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResolveStockAlertResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResolveStockAlertResponse) ProtoMessage() {}

func (x *ResolveStockAlertResponse) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_inventory_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResolveStockAlertResponse.ProtoReflect.Descriptor instead.
func (*ResolveStockAlertResponse) Descriptor() ([]byte, []int) {
	return file_inventory_inventory_proto_rawDescGZIP(), []int{12}
}

func (x *ResolveStockAlertResponse) GetProduct() *InventoryProduct {
	if x != nil {
		return x.Product
	}
	return nil
...
func (x *ResolveStockAlertResponse) GetAlreadyResolved() bool {
	if x != nil {
...
const file_inventory_inventory_proto_rawDesc = "" +
	"\n" +
	"\x19inventory/inventory.proto\x12\vhipstershop\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x13common/common.proto\"8\n" +
	...
	"\aproduct\x18\x01 \x01(\v2\x1d.hipstershop.InventoryProductR\aproduct\"\x9b\x01\n" +
	"\x18ResolveStockAlertRequest\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x129\n" +
	"\n" +
	"created_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12%\n" +
	"\x0ereorder_amount\x18\x03 \x01(\x03R\rreorderAmount\"\x7f\n" +
	"\x19ResolveStockAlertResponse\x127\n" +
	"\aproduct\x18\x01 \x01(\v2\x1d.hipstershop.InventoryProductR\aproduct\x12)\n" +
	"\x10already_resolved\x18\x02 \x01(\bR\x0falreadyResolved\"o\n" +
...
var file_inventory_inventory_proto_goTypes = []any{
	...
	(*ResolveStockAlertRequest)(nil),                // 11: hipstershop.ResolveStockAlertRequest
	(*ResolveStockAlertResponse)(nil),               // 12: hipstershop.ResolveStockAlertResponse
	(*XaPrepareCreateInventoryProductRequest)(nil),  // 13: hipstershop.XaPrepareCreateInventoryProductRequest
	(*timestamppb.Timestamp)(nil),                   // 14: google.protobuf.Timestamp
	(*common.Empty)(nil),                            // 15: hipstershop.Empty
	(*common.XaBranchRequest)(nil),                  // 16: hipstershop.XaBranchRequest
}
var file_inventory_inventory_proto_depIdxs = []int32{
	...
	14, // 5: hipstershop.ResolveStockAlertRequest.created_at:type_name -> google.protobuf.Timestamp
	0,  // 6: hipstershop.ResolveStockAlertResponse.product:type_name -> hipstershop.InventoryProduct
	15, // 7: hipstershop.InventoryService.ListInventory:input_type -> hipstershop.Empty
	2,  // 8: hipstershop.InventoryService.GetInventoryProduct:input_type -> hipstershop.GetInventoryProductRequest
	3,  // 9: hipstershop.InventoryService.ChangeInventoryProductStock:input_type -> hipstershop.ChangeInventoryProductStockRequest
	5,  // 10: hipstershop.InventoryService.SetInventoryProductStock:input_type -> hipstershop.SetInventoryProductStockRequest
	7,  // 11: hipstershop.InventoryService.CreateNewInventoryProduct:input_type -> hipstershop.CreateNewInventoryProductRequest
