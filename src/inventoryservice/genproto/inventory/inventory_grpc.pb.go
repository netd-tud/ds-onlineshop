...
type InventoryServiceClient interface {
	...
	ResolveStockAlert(ctx context.Context, in *ResolveStockAlertRequest, opts ...grpc.CallOption) (*ResolveStockAlertResponse, error)
...
func (c *inventoryServiceClient) ResolveStockAlert(ctx context.Context, in *ResolveStockAlertRequest, opts ...grpc.CallOption) (*ResolveStockAlertResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveStockAlertResponse)
	err := c.cc.Invoke(ctx, InventoryService_ResolveStockAlert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServiceServer interface {
	...
	ResolveStockAlert(context.Context, *ResolveStockAlertRequest) (*ResolveStockAlertResponse, error)
	// SAGA compensation adapter for CreateNewProduct. Accepts the same payload as CreateNewProduct
	// because DTM resends the original action's request bytes when invoking the compensating transaction.
...
func (UnimplementedInventoryServiceServer) ResolveStockAlert(context.Context, *ResolveStockAlertRequest) (*ResolveStockAlertResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveStockAlert not implemented")
}
...
func _InventoryService_ResolveStockAlert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveStockAlertRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).ResolveStockAlert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_ResolveStockAlert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).ResolveStockAlert(ctx, req.(*ResolveStockAlertRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveStockAlert",
			Handler:    _InventoryService_ResolveStockAlert_Handler,
		},
		{
