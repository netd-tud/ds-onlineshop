# Dynamic Load Producer for Monitoring Demo (Replicated Frontend)

This component deploys a dynamic load producer and **replicated** frontend demo to show simulate load throughout a day.
...
```bash
kustomize edit add component components/dynamic-load-producer-replicated
```
...
- base
components:
- components/dynamic-load-producer-replicated
```
...
**Deployment Details:**
- replicated by 3 instances
- uses the /heavyLoad endpoint to generate load
- **Access:** http://frontend-demo-replicated/heavyLoad?iters=10000000
